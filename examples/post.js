...
const handler = {
    ...
    home: function () {
        ...
        const result = synura.open('/views/post', {
            ...
            models: {
                link: { message: "example-post-id" },
                author: { message: "Loading..." },
                content: { details: [] },
                comments: { details: [] },
                menus: { details: ["Option 1", "Option 2"] }
            }
    ...
    onViewEvent: function (event) {
        ...
        if (event.eventId === "LOAD" || event.eventId === "REFRESH") {
            ...
            synura.update(viewId, {
                models: {
                    snackbar: { message: `You clicked ${event.data.menu}` }
                }
            });
            ...
            synura.update(viewId, {
                models: {
                    snackbar: { message: `You clicked author: ${event.data.author}` }
                }
            });
        }
    },
            ...
            models: {
                ...
                content: {
                    details: [
                        ...
                        { type: "image", "value": "https://picsum.photos/seed/picsum/400/200" },
                        { type: "text", "value": "More text below the image." },
                        { type: "link", value: "Click here for more", link: "https://example.com/post/123" }
                    ]
                },
                comments: {
                    details: [
