...
La pantalla principal de la aplicación es donde gestionas tus runtimes. La barra superior (barra de aplicación) es tu herramienta de navegación principal.
