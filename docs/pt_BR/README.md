...
## O que é Synura?
Synura é um aplicativo versátil que permite navegar por conteúdo de várias fontes usando poderosos mini-aplicativos chamados "extensões". Pense nisso como um navegador, mas em vez de sites, você usa extensões para obter conteúdo em um formato de aplicativo nativo e limpo.
